...
Open the link, enter your coordinates on the fixed coordinates version/set the map center properly, (in large cities like Munich lower the radius, by default it's set to 10km) and then start.
