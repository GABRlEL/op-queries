...
// Bus stop / bus platform results excluded.
// Area: {{radius_m}} m around {{coords}}

(
  // Standalone benches
  nwr["amenity"="bench"]
    ["bus"!="yes"]["highway"!="bus_stop"]["public_transport"!="platform"]["public_transport"!="stop_position"]
  ...
  // Features that have an associated bench, e.g. shelters, platforms, viewpoints, etc.
  // Excludes bench=no and bus-stop-ish objects.
  nwr["bench"]["bench"!="no"]
    ["bus"!="yes"]["highway"!="bus_stop"]["public_transport"!="platform"]["public_transport"!="stop_position"]
    (around:{{radius_m}},{{coords}});
